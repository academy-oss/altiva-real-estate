          ...
          <div className="rounded-3xl border border-cream/10 bg-navy-light p-7 text-center">
            ...
            <ul className="space-y-6 text-center text-sm text-cream/75">
              ...
              <li className="flex flex-col items-center gap-2 text-center">
                ...
                <a href={whatsappUrl()} target="_blank" rel="noopener noreferrer" className="text-center hover:text-copper">
                  <bdi dir="ltr">+965 5777 5289</bdi>
                </a>
              </li>
              <li className="flex flex-col items-center gap-2 text-center">
                <Phone size={18} className="shrink-0 text-copper" />
                <a href="tel:+96522200355" className="text-center hover:text-copper">
                  <bdi dir="ltr">+965 22200355</bdi>
                </a>
              </li>
              <li className="flex flex-col items-center gap-2 text-center">
              ...
              <li className="flex flex-col items-center gap-2 text-center">
                <Mail size={18} className="shrink-0 text-copper" />
                <a href="mailto:info@altivaproperties.com" className="text-center hover:text-copper">
